...
public class Principal {
    ...
    private final String API_KEY = "&apikey=e8fe66a8";
    ...
    private void mostarSeriesBuscadas() {
       ...
       /*
       Ejemplo anterior de como guardamos e imprimiamos las series
       List<Serie>  series = new ArrayList<>();

        series = datosSeries.stream()
                .map(d -> new Serie(d))
                .collect(Collectors.toList()); //conversion a una nuvea lista
        */
    ...
    private void  filtrarSeriesPorTemporadaYEvaluacion(){
        ...
        System.out.println("Filtar series con cuantas temporadas?");
        var totalTemporada = teclado.nextInt();
        teclado.nextLine();
        System.out.println("¿Apartir de que evaluacion?");
        var evaluacion = teclado.nextDouble();
        teclado.nextLine();

        List<Serie> filtroSeries = repositorio.seriesPorTemporadaYEvaluacion( totalTemporada, evaluacion);
